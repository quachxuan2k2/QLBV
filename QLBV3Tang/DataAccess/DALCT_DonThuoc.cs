...
namespace DataAccessLayer
{
    public class DALCT_DonThuoc
    {
        ...
        public DataTable GetThuoc(int madonthuoc)
        {
            ...
            ct_donthuoc.SelectCommand = new SqlCommand("SELECT dt.MaDonThuoc, dt.MaThuoc,t.TenThuoc, dt.SoLuong, dt.ThanhTien, dt.LieuDung,  t.GiaBan, t.HangSX FROM ct_DonThuoc dt JOIN Thuoc t ON dt.MaThuoc = t.MaThuoc WHERE dt.MaDonThuoc = @MaDonThuoc", db.conn);
